...
<?php
	...
	if(isset($_POST['upload'])){
		...
		$target = "onepiece/".basename($_FILES['image']['name']);
		...
		$sql = "INSERT INTO onepiece(image,text)VALUES('$image','$text')";
		...
		if(move_uploaded_File($_FILES['image']['tmp_name'],$target)){
			header("Location:upOnepiece.php?Uploaded");
		}else{
			header("Location:upOnepiece.php?Sorry");
		}
		}else{
...
<div id="f">
<form method="POST" action="upOnePiece.php" enctype="multipart/form-data">
...
<?php
	function deletePhoto($conn){
		...
		if(isset($_POST['del'])){
			...
			header('Location:upOnePiece.php?deleted');
