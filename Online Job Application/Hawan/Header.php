  ...
  <div class="container">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <!--<a class="navbar-brand" href="index.php"><img src="BannerHawan/FinalLogo.png" class="img-responsive"></a>-->
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="../7th SEM Project/HawanFORMED.php" target="_blank">Apply</a></li>
