...
if(isset($_POST['submit'])){
  ...
  /////////////////////////////////
  $target="Hawanimages/".basename($_FILES['photo']['name']);
...
$sql1= "SELECT * FROM hawan WHERE Email='$email'";
...
$sql2= "SELECT * FROM hawan WHERE Phone_Number='$phone'";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
   ...
   $sql= "INSERT INTO hawan(First_Name,Last_Name,Gender,DOB,Email,Phone_Number,Photo,Category,Education,Skills,Hobbies,Why) VALUES('$first','$last'
 ...
 <div class="container">
  <div class="row">
   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <img src="BannerHawan/logo.jpg" class="img-responsive">
   </div><!--col-->
   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
