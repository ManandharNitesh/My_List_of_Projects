    ...
    if($queryResults > 0){
      while($row = mysqli_fetch_assoc($result)){
        ...
        ?>
            ...
            <img src="../7th SEM Project/Cloudimages/<?php echo $image;?> " class="img-responsive">
            </div><!--end of well-->
...
<?php
  function deletePhoto($conn){
    ...
    if(isset($_POST['del'])){
      ...
      $image=$_POST['image'];
      $file_to_delete ="../7th SEM Project/Cloudimages/$image";
 ...
 */     
      ...
      //create connnection to database then run query method on sql statement
            $sql="DELETE FROM cloud WHERE id='$id'";
