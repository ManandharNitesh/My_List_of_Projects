...
Border defaulted,red;
    ...
    public void bjTable1(){
        try{
            String sql = "Select * From Book where Book_ID=? OR Book_Name=? OR Publisher=?";
    ...
    public void bjTable2(){
        try{
            String sql = "Select * From Issue where Book_ID=? OR Book_Name=? OR Publisher=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
            pst.setString(2,jTextField2.getText());
            pst.setString(3,jTextField3.getText());
    ...
    public void bjTable3(){
        try{
            String sql = "Select * From bReturn where Book_ID=? OR Book_Name=? OR Publisher=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
            pst.setString(2,jTextField2.getText());
            pst.setString(3,jTextField3.getText());
        ...
        try{
            ...
            if(rs.next()){
               ...
               */ 
                ...
                JOptionPane.showMessageDialog(null,"Incoreect Info");
            }
