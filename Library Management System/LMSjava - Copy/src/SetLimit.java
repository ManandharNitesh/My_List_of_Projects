...
ResultSet rs;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String check = "Select * from limited where lid = ?";
        try{
            pst = conn.prepareStatement(check);
            pst.setString(1,"1");
            rs =pst.executeQuery();
            if(rs.next()){
                String update = "update limited set time = ? where lid = ?";
                ...
                if(ress>0){
                    JOptionPane.showMessageDialog(null,"Time limit Updated");
                    new Fine();
                }
                }
