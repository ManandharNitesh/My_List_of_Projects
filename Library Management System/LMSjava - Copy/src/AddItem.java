...
Border defaulted,red;
    ...
    public void bAdd(){
        ...
        String selectSql = "Select * From Item_Info Where PID=?";
        try{
            ...
            if(rs.next()){
                ...
                String updateSql = "Update Item_Info set Quantity=? where PID=?";
                try{
                    ...
                    if(res>0){
                        ...
                        JOptionPane.showMessageDialog(null,"PID Doesnot Match");
                    }
                }catch(Exception e){
                    JOptionPane.showMessageDialog(null,e);
                }
            }else{
                    String sql = "Insert into Item_Info(PID,Item_Name,Item_Category,Item_Description,Quantity)VALUES(?,?,?,?,?)";
                     try{
    ...
    public void BookSearch(){
        String sql = "Select * From Item_Info where PID=?";
        try{
            pst = conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
            rs = pst.executeQuery();
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null,"PID doesnot exist");
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,e);
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Item_Description");
        ...
        setSize(new java.awt.Dimension(562, 545));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!jTextField1.getText().equals("")){
            ...
            jTextField1.setBorder(red);
            JOptionPane.showMessageDialog(null,"Please Enter PID");
        }
